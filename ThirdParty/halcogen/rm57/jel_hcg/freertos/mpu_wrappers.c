...
{
	BaseType_t xRunningPrivileged = prvRaisePrivilege();
	MPU_vTaskSetThreadLocalStoragePointer( xTaskToSet, xIndex, pvValue );
	portRESET_PRIVILEGE( xRunningPrivileged );
}
...
void *MPU_pvTaskGetThreadLocalStoragePointer( TaskHandle_t xTaskToQuery, BaseType_t xIndex )
{
	void *xReturn;
	BaseType_t xRunningPrivileged = prvRaisePrivilege();
	xReturn = MPU_pvTaskGetThreadLocalStoragePointer( xTaskToQuery, xIndex );
	portRESET_PRIVILEGE( xRunningPrivileged );
	return xReturn;
}
...
BaseType_t MPU_xQueueGenericReceive( QueueHandle_t xQueue, void * const pvBuffer, TickType_t xTicksToWait, const BaseType_t xJustPeek )
{
	BaseType_t xReturn;
	BaseType_t xRunningPrivileged = prvRaisePrivilege();
	xReturn = MPU_xQueueGenericReceive( xQueue, pvBuffer, xTicksToWait, xJustPeek );
	portRESET_PRIVILEGE( xRunningPrivileged );
	return xReturn;
}
